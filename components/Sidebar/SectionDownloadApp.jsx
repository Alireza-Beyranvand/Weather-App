...
export default function SectionDownloadApp() {
    return (
        <>
            <div className="grid grid-cols-6 mx-4 bg-slate-800 rounded-lg">
            ...
            <div className="md:grid grid-cols-3 mx-4 bg-slate-800  rounded-lg mt-2 logo">
